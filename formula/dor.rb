...
class Dor < Formula
  ...
  url "https://github.com/DroidsOnRoids/dor-flutter-cli/releases/download/0.7.1/dor.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
  sha256 "d35c49a45656ab0425318a4520ba970d8e6a3a862e5cf3a8718422c28367dbc4"
