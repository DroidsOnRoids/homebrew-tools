...
class Dor < Formula
  ...
  url "https://github.com/DroidsOnRoids/dor-flutter-cli/releases/download/0.2.1/dor.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
  sha256 "34397b440727b6e63bdeb5321f23522bd06a665845b7ced3dee0a273c36ab66b"
