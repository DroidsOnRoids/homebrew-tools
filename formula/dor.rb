...
class Dor < Formula
  ...
  url "https://github.com/DroidsOnRoids/dor-flutter-cli/releases/download/0.4.4/dor.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
  sha256 "bbb74f06cf683b8a5ccd28206497260f34491e7c6fb8d069f349efd802a8f49d"
