...
class Dor < Formula
  ...
  url "https://github.com/DroidsOnRoids/dor-flutter-cli/releases/download/0.2.2/dor.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
  sha256 "072661b2645cb215c6a942047ceb5da52554cd321ca92b474c51f42dc2d830cf"
