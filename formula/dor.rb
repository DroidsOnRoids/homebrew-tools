...
class Dor < Formula
  ...
  url "https://github.com/DroidsOnRoids/dor-flutter-cli/releases/download/0.2.0/dor.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
  sha256 "259185a03af184bbfa85a7f0e61037d44d6aec2108d543b240f257910d54d0e6"
